...
/*! \file int_vector.hpp
    ...
    \author Simon Gog
*/
#ifndef INCLUDED_SDSL_INT_VECTOR_ALIGNED
#define INCLUDED_SDSL_INT_VECTOR_ALIGNED
...
public:
	...
	friend class sdsl::memory_manager;
...
public:
	...
	struct raw_wrapper {
		...
		serialize(std::ostream& out, structure_tree_node* v = nullptr, std::string name = "") const
		{
			...
			structure_tree::add_child(v, name, sdsl::util::class_name(*this));
...
private:
	...
	// typename t_int_vector::value_type* m_word(nullptr);
